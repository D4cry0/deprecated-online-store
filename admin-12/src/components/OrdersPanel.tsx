            ...
            <div className='px-0 py-2'>
                ...
                <div className='hstack gap-0 d-lg-flex align-items-lg-center' style={{borderTop: '2px solid var(--bs-gray-400)', borderBottom: '2px solid var(--bs-gray-400)'}}>
                    ...
                    <div className='card' style={{borderStyle: 'none'}}>
                        <div className='card-body d-flex flex-col p-0 m-0' data-bs-toggle='tooltip' data-bss-tooltip title='Orden de Venta <br /> IDSO: {{ ID_SO }}' data-bs-html='true'>
                    ...
                    <div className='card' style={{borderStyle: 'none'}}>
                        <div className='card-body d-flex flex-col p-0 m-0' data-bs-toggle='tooltip' data-bss-tooltip title='Resumen de la orden' data-bs-html='true'>
                    ...
                    <div className='card' style={{borderStyle: 'none'}}>
                        <div className='card-body d-flex flex-col-2 p-0 my-1'><small style={{fontSize: '0.8rem'}}>Pago</small><span className='badge bg-secondary' data-bs-toggle='tooltip' data-bss-tooltip title='Estatus del envio' style={{fontSize: '0.6rem'}}>PENDIENTE</span>
                    ...
                    <div className='card mx-3' style={{borderStyle: 'none'}}>
                        <div className='card-body p-0 m-0'><div className='d-flex flex-row align-items-center p-0 m-0'>
                            ...
                            <select id='selectexe-{{ hashPermLink ID_SO }}' defaultValue={'s'} className='form-select form-select-sm w-75' aria-label='.form-select-sm'>
