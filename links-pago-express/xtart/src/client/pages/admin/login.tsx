...
const Login: NextPage = () => {
    ...
    const viewProps: LoginPlaceHolders = {
        ...
        pass: {
            ...
            validateErrorMsg1: 'La contraseña debe se mínimo de 8 dígitos y contener al menos: un símbolo, números, minúsculas y mayúsculas.',
        },
        error: '',
        btnLogin: {
    ...
    return (
        <LoginProvider >
            <UILogin isAdmin={true} view={viewProps} />
        </LoginProvider>
    );
}
